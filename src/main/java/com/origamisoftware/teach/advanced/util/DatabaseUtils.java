...
public class DatabaseUtils {
    ...
    private static final String JDBC_DRIVER_CLASS_PROPERTY_KEY = "connection.driver_class";
    private static final String DATABASE_USER_NAME = "hibernate.connection.username";
    private static final String DATABASE_USER_PASSWORD = "hibernate.connection.password";
    ...
    public static Connection getConnection() throws DatabaseConnectionException {
        ...
        try {
            ...
            connection = DriverManager.getConnection(getPropFromConfig(DATABASE_URL), getPropFromConfig(DATABASE_USER_NAME), getPropFromConfig(DATABASE_USER_PASSWORD));
